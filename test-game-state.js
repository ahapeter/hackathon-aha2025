        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post('http://localhost:3000/api/game-state', {
                            presentationId: TEST_PRESENTATION_ID,
                            config: sampleConfig,
                            state: sampleState
                        })];
                case 1:
                    ...
                    return [4 /*yield*/, axios_1.default.put('http://localhost:3000/api/game-state', {
                            type: 'event',
                            presentationId: TEST_PRESENTATION_ID,
                            data: {
                                event_name: 'STARTED',
                ...
                case 3:
                    ...
                    return [4 /*yield*/, axios_1.default.get("http://localhost:3000/api/game-state?presentationId=".concat(TEST_PRESENTATION_ID))];
                case 4:
                    response = _c.sent();
                    ...
                    return [4 /*yield*/, axios_1.default.delete("http://localhost:3000/api/game-state?presentationId=".concat(TEST_PRESENTATION_ID))];
                case 5:
                    _c.sent();
